...
const coreValues = [
  {
    ...
    description:
      'We believe in honest partnerships, clear roadmaps, and realistic delivery expectations without hidden overheads.',
  },
  {
    icon: <ExcellenceIcon className="text-brand-orange w-6 h-6" />,
    title: 'Elite Technical Depth',
    description:
      'Our consultants hold top-tier certifications in Oracle, Workday, and advanced systems integration patterns.',
  },
  {
    icon: <ValueIcon className="text-brand-orange w-6 h-6" />,
    title: 'Value-First Engineering',
    description:
      'We prioritize reducing technical debt and streamlining architectures to maximize client return on investment.',
  },
]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold text-brand-cream leading-[1.2]">
              Bridging the Gap Between <span className="text-brand-orange">Strategy</span> &{' '}
              <span className="text-brand-cream">Architectural Execution</span>
            </h2>

            <p className="text-brand-cream/75 text-base md:text-lg leading-relaxed">
              Founded in 2016, Escala de services was established to redefine how enterprises adopt
              cloud technologies. Instead of standard &quot;cookie-cutter&quot; templates, we build
              bespoke migration roadmaps, cloud custom integrations, and data systems.
            </p>

            <p className="text-brand-cream/65 text-sm md:text-base leading-relaxed">
              We focus on high-impact projects. Whether automating financial workflows via Workday,
              deploying high-availability Oracle cloud infrastructure, or orchestrating real-time
              integrations, we deliver with speed and architectural clarity.
            </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-brand-cream/60 text-xs mt-0.5">
                    Dual-shore execution across Europe and Asia.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-brand-cream/60 text-xs mt-0.5">
                    Rigorous quality checkpoints at every milestone.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="bg-brand-black/40 border border-brand-tan/10 p-8 rounded-2xl space-y-4 shadow-xl">
              ...
              <p className="text-brand-cream/77 text-sm leading-relaxed">
                &quot;We do not just install software; we align technology to business velocity. If
                a system is not actively accelerating your operations, it is creating friction. We
                eradicate friction.&quot;
              </p>
