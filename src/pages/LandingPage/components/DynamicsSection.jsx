...
export const DynamicsSection = () => {
  ...
  return (
    <section id="insights" className="py-24 bg-brand-black border-t border-brand-mud-light relative">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div
            ...
            className="group relative h-[420px] rounded-2xl bg-brand-mud overflow-hidden border border-brand-tan/10 hover:border-brand-orange/45 cursor-pointer shadow-xl transition-all duration-500 hover:-translate-y-2"
          >
            {/* Background Glow */}
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 rounded-full border border-brand-orange/30 flex items-center justify-center group-hover:border-brand-orange/60 transition-colors duration-500">
              <div className="w-40 h-40 rounded-full border border-dashed border-brand-orange/20 animate-spin" style={{ animationDuration: '40s' }} />
              <div className="absolute w-24 h-24 rounded-full bg-gradient-to-br from-brand-orange to-brand-tan opacity-25 blur-md" />
            </div>
          ...
          >
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-32 flex flex-wrap gap-3 justify-center items-center">
              <div className="w-10 h-10 rounded bg-brand-black border border-brand-orange/20 flex items-center justify-center text-brand-tan text-xs font-bold shadow-inner group-hover:border-brand-orange/50 transition-colors">ERP</div>
              <div className="w-10 h-10 rounded bg-brand-black border border-brand-orange/20 flex items-center justify-center text-brand-tan text-xs font-bold shadow-inner group-hover:border-brand-orange/50 transition-colors">HCM</div>
              <div className="w-10 h-10 rounded bg-brand-black border border-brand-orange/20 flex items-center justify-center text-brand-tan text-xs font-bold shadow-inner group-hover:border-brand-orange/50 transition-colors">SCM</div>
              <div className="w-10 h-10 rounded bg-brand-black border border-brand-orange/20 flex items-center justify-center text-brand-tan text-xs font-bold shadow-inner group-hover:border-brand-orange/50 transition-colors">BI</div>
            </div>
          ...
          <div
            ...
            className="group relative h-[420px] rounded-2xl bg-brand-mud overflow-hidden border border-brand-tan/10 hover:border-brand-orange/45 cursor-pointer shadow-xl transition-all duration-500 hover:-translate-y-2 flex flex-col justify-end p-8"
          >
            {/* Background Glow */}
            <div className="absolute inset-0 bg-gradient-to-t from-brand-black via-brand-mud/60 to-transparent z-10" />
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center z-20 p-6 text-center space-y-4">
              <div className="w-12 h-12 rounded-full bg-brand-orange/15 border border-brand-orange/30 flex items-center justify-center text-brand-orange group-hover:bg-brand-orange group-hover:text-white transition-all duration-300">
                <ArrowIcon className="w-6 h-6 group-hover:translate-x-0.5 transition-transform" />
              </div>
              <div className="space-y-1">
                <h4 className="text-2xl font-black text-white tracking-wider uppercase">
                  INSIGHTS
                </h4>
