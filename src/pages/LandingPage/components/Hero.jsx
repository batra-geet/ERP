...
export const Hero = () => {
  ...
  return (
    <section id="home" className="relative h-[85vh] min-h-[500px] flex items-center justify-center overflow-hidden bg-brand-tan">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Tech Grid Matrix */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#29231f_1px,transparent_1px),linear-gradient(to_bottom,#29231f_1px,transparent_1px)] bg-[size:5rem_5rem] opacity-5" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full h-full flex flex-col justify-center text-left">
        <div className="relative min-h-[250px] md:min-h-[220px]">
          {slides.map((slide, idx) => (
            <div
              key={idx}
              className={`absolute inset-0 flex flex-col justify-center transition-all duration-1000 ${idx === currentSlide
            ...
            >
              ...
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-black tracking-wider leading-none mb-6 max-w-4xl uppercase">
                {slide.header}
              </h2>
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex gap-3 z-20">
          {slides.map((_, idx) => (
            <button
              ...
              className={`w-3.5 h-3.5 rounded-full transition-all duration-300 cursor-pointer ${idx === currentSlide ? 'bg-brand-orange scale-110' : 'bg-black hover:bg-brand-tan/80'
                }`}
